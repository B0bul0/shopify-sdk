...
public class ShopifySdk {
	...
	public Metafield createCustomerMetafield(
			final ShopifyCustomerMetafieldCreationRequest shopifyCustomerMetafieldCreationRequest) {
		...
		final Response response = post(getWebTarget().path(CUSTOMERS)
				.path(shopifyCustomerMetafieldCreationRequest.getCustomerId()).path(METAFIELDS), metafieldRoot);
